...
The simplest way to install portfoliovisualizerapi is using Pip.

.. code-block:: console

    $ pip install portfoliovisualizerapi

This will install ``portfoliovisualizerapi`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/David-Carrasco/portfoliovisualizerapi/issues>`_.
