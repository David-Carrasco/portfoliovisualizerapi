...
The portfoliovisualizerapi project implements a regression
...
not broken existing functionality. The portfoliovisualizerapi
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make test

To run tests verbosely use:

.. code-block:: console

    (portfoliovisualizerapi) $ make test-verbose
...
``portfoliovisualizerapi`` package has been installed. If this is
not the case then you will likely need to set the ``PYTHONPATH`` environment
variable so that the ``portfoliovisualizerapi`` package can be found.

.. code-block:: console

    (portfoliovisualizerapi) $ cd tests
    (portfoliovisualizerapi) $ python -m unittest

Individual unit tests can be run also.

.. code-block:: console

    (portfoliovisualizerapi) $ python -m test_version
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make coverage
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make style
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make format
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make sort-imports
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make check-static-analysis
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make check-lint
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make check-types
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make docs
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make check-docs
...
.. code-block:: console
    ...
    (portfoliovisualizerapi) $ make serve-docs
...
- Create and push a repo tag to Github. As a convention use the package
  ...
  - This will trigger Github to create a release at:
    ...
    ::
        ...
        https://github.com/{username}/portfoliovisualizerapi/releases/{tag}
...
- Create the release distribution. This project produces an artefact called a
  ...
  .. code-block:: console
      ...
      (portfoliovisualizerapi) $ make dist
...
- Test the release distribution. This involves creating a virtual environment,
  ...
  .. code-block:: console
      ...
      (portfoliovisualizerapi) $ make dist-test

- Upload the release to PyPI using

  .. code-block:: console

      (portfoliovisualizerapi) $ make dist-upload

  The package should now be available at https://pypi.org/project/portfoliovisualizerapi/
